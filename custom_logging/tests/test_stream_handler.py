...
from auxiliary.custom_logging.colored_formatter import ColoredFormatter
from auxiliary.custom_logging.stream_handler import get_stream_handler
...
class TestStreamHandler:
    ...
    def test_get_file_handler_returns_handler(self) -> None:
        ...
        logging_handler = get_stream_handler()
    ...
    def test_get_file_handler_custom_logging_level(self) -> None:
        ...
        logging_handler = get_stream_handler(logging_level=logging.WARNING)
    ...
    def test_get_file_handler_verbose(self) -> None:
        ...
        logging_handler = get_stream_handler(verbose=True)
    ...
    def test_get_file_handler_not_verbose(self) -> None:
        ...
        logging_handler = get_stream_handler(verbose=False)
        formatter = logging_handler.formatter
        expected_format = ' | '.join([
            '%(asctime)s',
            '%(levelname)s',
